                ...
                <div class="shrink-0">
                    <div class="sm:sticky sm:top-[calc(var(--header-height)+2.5rem)] flex flex-col gap-2.5">
                        <img :src="personData?.photo ? fileUrl(personData.photo) : '/img/person.jpg'"
                             :alt="personData.name"
                             class="block rounded-lg w-full sm:w-62.5 sm:max-h-100 border dark:border-neutral-800 object-cover"/>
                    </div>
                </div>
                ...
                <div class="flex flex-col font-roboto gap-10 grow">
                    <div class="flex flex-col gap-5">
                        <div>
                            ...
                            <h3 v-if="personData.original_name" class="font-medium text-xl text-neutral-400 leading-9">
                        ...
                        <table class="text-lg">
                            ...
                            <tr v-if="personData.birth_date">
                                <td class="w-37.5 font-medium">Дата рождения</td>
                                <td class="font-light">
                            ...
                            <tr v-if="personData.death_date">
                                <td class="w-37.5 font-medium">Дата смерти</td>
                                <td class="font-light">
                            ...
                            <tr v-if="personData.sex">
                                <td class="w-37.5 font-medium">Пол</td>
                                <td class="font-light">
                            ...
                            <tr v-if="personData.country">
                                <td class="w-37.5 font-medium align-top">Страна</td>
                                <td class="font-light">
                            ...
                            <tr v-if="(personData.roles ?? []).length > 0">
                                <td class="w-37.5 font-medium align-top">Деятельность</td>
                                <td class="font-light">
                                    <p>
                                        {{
                            ...
                            <tr v-if="(person?.genres ?? []).length > 0">
                                <td class="w-37.5 font-medium align-top">Жанр</td>
                                <td class="font-light">
                    ...
                    <div v-if="(personData.films ?? []).length > 0"
                        ...
                        <h1 class="font-bold text-2xl leading-4">
                            <span>Фильмы</span>
                            <span class="ms-1.5 text-neutral-400 font-normal">{{ new Set((personData.films ?? []).map(film => film.film_id)).size }}</span>
                        </h1>
                        ...
                        <div class="flex flex-wrap gap-5">
                            <NuxtLink
                                ...
                                <div v-if="person.film?.cover"
                                     class="w-full h-57.5 object-cover bg-cover bg-center bg-no-repeat rounded-lg"
